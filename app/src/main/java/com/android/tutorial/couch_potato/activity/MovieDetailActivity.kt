...
import com.android.tutorial.couch_potato.adapter.ViewLinkListAdapter
import com.bumptech.glide.Glide
import kotlinx.android.synthetic.main.item_movie_detail.*


class MovieDetailActivity : AppCompatActivity() {
    private lateinit var viewLinkListAdapter: ViewLinkListAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.item_movie_detail)

        viewLinkListAdapter = ViewLinkListAdapter()
